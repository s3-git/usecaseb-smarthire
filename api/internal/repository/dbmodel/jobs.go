...
type Job struct {
	...
	PostingStatus   string     `boil:"posting_status" json:"posting_status" toml:"posting_status" yaml:"posting_status"`
	...
	MinimumFitScore int16      `boil:"minimum_fit_score" json:"minimum_fit_score" toml:"minimum_fit_score" yaml:"minimum_fit_score"`
	AssigneeUserID  null.Int64 `boil:"assignee_user_id" json:"assignee_user_id,omitempty" toml:"assignee_user_id" yaml:"assignee_user_id,omitempty"`
	PostedDate      null.Time  `boil:"posted_date" json:"posted_date,omitempty" toml:"posted_date" yaml:"posted_date,omitempty"`
	...
	IsAutoPost      bool       `boil:"is_auto_post" json:"is_auto_post" toml:"is_auto_post" yaml:"is_auto_post"`
	JobPostingNote  string     `boil:"job_posting_note" json:"job_posting_note" toml:"job_posting_note" yaml:"job_posting_note"`
...
var JobColumns = struct {
	...
	MinimumFitScore: "minimum_fit_score",
	AssigneeUserID:  "assignee_user_id",
	PostedDate:      "posted_date",
	StartDate:       "start_date",
	EndDate:         "end_date",
	IsAutoPost:      "is_auto_post",
	JobPostingNote:  "job_posting_note",
...
var JobTableColumns = struct {
	...
	PostingStatus:   "jobs.posting_status",
	Level:           "jobs.level",
	Overview:        "jobs.overview",
	Department:      "jobs.department",
	MinimumFitScore: "jobs.minimum_fit_score",
	AssigneeUserID:  "jobs.assignee_user_id",
	PostedDate:      "jobs.posted_date",
	StartDate:       "jobs.start_date",
	EndDate:         "jobs.end_date",
	IsAutoPost:      "jobs.is_auto_post",
	JobPostingNote:  "jobs.job_posting_note",
...
var JobWhere = struct {
	...
	PostingStatus   whereHelperstring
	Level           whereHelperint
	Overview        whereHelperstring
	Department      whereHelperstring
	MinimumFitScore whereHelperint16
	AssigneeUserID  whereHelpernull_Int64
	PostedDate      whereHelpernull_Time
	StartDate       whereHelpernull_Time
	EndDate         whereHelpernull_Time
	IsAutoPost      whereHelperbool
	JobPostingNote  whereHelperstring
	CreatedAt       whereHelpertime_Time
	UpdatedAt       whereHelpertime_Time
}{
	ID:              whereHelperint64{field: "\"jobs\".\"id\""},
	JobTitle:        whereHelperstring{field: "\"jobs\".\"job_title\""},
	PostingStatus:   whereHelperstring{field: "\"jobs\".\"posting_status\""},
	Level:           whereHelperint{field: "\"jobs\".\"level\""},
	Overview:        whereHelperstring{field: "\"jobs\".\"overview\""},
	Department:      whereHelperstring{field: "\"jobs\".\"department\""},
	MinimumFitScore: whereHelperint16{field: "\"jobs\".\"minimum_fit_score\""},
	AssigneeUserID:  whereHelpernull_Int64{field: "\"jobs\".\"assignee_user_id\""},
	PostedDate:      whereHelpernull_Time{field: "\"jobs\".\"posted_date\""},
	StartDate:       whereHelpernull_Time{field: "\"jobs\".\"start_date\""},
	EndDate:         whereHelpernull_Time{field: "\"jobs\".\"end_date\""},
	IsAutoPost:      whereHelperbool{field: "\"jobs\".\"is_auto_post\""},
	JobPostingNote:  whereHelperstring{field: "\"jobs\".\"job_posting_note\""},
...
type jobR struct {
	AssigneeUser    *User               `boil:"AssigneeUser" json:"AssigneeUser" toml:"AssigneeUser" yaml:"AssigneeUser"`
...
func (o *Job) GetAssigneeUser() *User {
	if o == nil {
		return nil
	}

	return o.R.GetAssigneeUser()
}

func (r *jobR) GetAssigneeUser() *User {
	if r == nil {
		return nil
	}

	return r.AssigneeUser
}

func (o *Job) GetJobApplications() JobApplicationSlice {
	if o == nil {
		return nil
	}
...
func (r *jobR) GetJobApplications() JobApplicationSlice {
	if r == nil {
		return nil
	}
...
var (
	jobAllColumns            = []string{"id", "job_title", "posting_status", "level", "overview", "department", "minimum_fit_score", "assignee_user_id", "posted_date", "start_date", "end_date", "is_auto_post", "job_posting_note", "created_at", "updated_at"}
	jobColumnsWithoutDefault = []string{"id", "job_title", "posting_status"}
	jobColumnsWithDefault    = []string{"level", "overview", "department", "minimum_fit_score", "assignee_user_id", "posted_date", "start_date", "end_date", "is_auto_post", "job_posting_note", "created_at", "updated_at"}
...
func (q jobQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Job, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodel: failed to execute a one query for jobs")
	}
...
func (q jobQuery) All(ctx context.Context, exec boil.ContextExecutor) (JobSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbmodel: failed to assign all query results to Job slice")
	}
...
func (q jobQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: failed to count jobs rows")
	}
...
func (q jobQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbmodel: failed to check if jobs exists")
	}

	return count > 0, nil
}

// AssigneeUser pointed to by the foreign key.
func (o *Job) AssigneeUser(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"id\" = ?", o.AssigneeUserID),
	}
...
func (o *Job) JobApplications(mods ...qm.QueryMod) jobApplicationQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"job_applications\".\"job_id\"=?", o.ID),
	)

	return JobApplications(queryMods...)
}

// LoadAssigneeUser allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (jobL) LoadAssigneeUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeJob interface{}, mods queries.Applicator) error {
	var slice []*Job
	var object *Job
	...
	if singular {
		...
		if !queries.IsNil(object.AssigneeUserID) {
			args[object.AssigneeUserID] = struct{}{}
		}
		...
		for _, obj := range slice {
			...
			if !queries.IsNil(obj.AssigneeUserID) {
				args[obj.AssigneeUserID] = struct{}{}
			}
	...
	if singular {
		...
		object.R.AssigneeUser = foreign
		if foreign.R == nil {
			foreign.R = &userR{}
		}
		foreign.R.AssigneeUserJobs = append(foreign.R.AssigneeUserJobs, object)
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if queries.Equal(local.AssigneeUserID, foreign.ID) {
				local.R.AssigneeUser = foreign
				if foreign.R == nil {
					foreign.R = &userR{}
				}
				foreign.R.AssigneeUserJobs = append(foreign.R.AssigneeUserJobs, local)
				break
			}
		}
	}
...
func (jobL) LoadJobApplications(ctx context.Context, e boil.ContextExecutor, singular bool, maybeJob interface{}, mods queries.Applicator) error {
	var slice []*Job
	var object *Job
	...
	query := NewQuery(
		...
		qm.WhereIn(`job_applications.job_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetAssigneeUser of the job to the related item.
// Sets o.R.AssigneeUser to related.
// Adds o to related.R.AssigneeUserJobs.
func (o *Job) SetAssigneeUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	queries.Assign(&o.AssigneeUserID, related.ID)
	if o.R == nil {
		o.R = &jobR{
			AssigneeUser: related,
		}
	} else {
		o.R.AssigneeUser = related
	}

	if related.R == nil {
		related.R = &userR{
			AssigneeUserJobs: JobSlice{o},
		}
	} else {
		related.R.AssigneeUserJobs = append(related.R.AssigneeUserJobs, o)
	}

	return nil
}

// RemoveAssigneeUser relationship.
// Sets o.R.AssigneeUser to nil.
// Removes o from all passed in related items' relationships struct.
func (o *Job) RemoveAssigneeUser(ctx context.Context, exec boil.ContextExecutor, related *User) error {
	var err error

	queries.SetScanner(&o.AssigneeUserID, nil)
	if _, err = o.Update(ctx, exec, boil.Whitelist("assignee_user_id")); err != nil {
		return errors.Wrap(err, "failed to update local table")
	}

	if o.R != nil {
		o.R.AssigneeUser = nil
	}
	if related == nil || related.R == nil {
		return nil
	}

	for i, ri := range related.R.AssigneeUserJobs {
		if queries.Equal(o.AssigneeUserID, ri.AssigneeUserID) {
			continue
		}

		ln := len(related.R.AssigneeUserJobs)
		if ln > 1 && i < ln-1 {
			related.R.AssigneeUserJobs[i] = related.R.AssigneeUserJobs[ln-1]
		}
		related.R.AssigneeUserJobs = related.R.AssigneeUserJobs[:ln-1]
		break
	}
	return nil
}
...
func (o *Job) AddJobApplications(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*JobApplication) error {
	var err error
...
func FindJob(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Job, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodel: unable to select from jobs")
	}
...
func (o *Job) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbmodel: no jobs provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodel: unable to insert into jobs")
	}
...
func (o *Job) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbmodel: unable to update jobs, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: unable to update jobs row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: failed to get rows affected by update for jobs")
	}
...
func (q jobQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: unable to update all for jobs")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: unable to retrieve rows affected for jobs")
	}
...
func (o JobSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: unable to update all in job slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: unable to retrieve rows affected all in update all job")
	}
	return rowsAff, nil
}
...
func (o *Job) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("dbmodel: no jobs provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbmodel: unable to upsert jobs, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(jobPrimaryKeyColumns) == 0 {
				return errors.New("dbmodel: unable to upsert jobs, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodel: unable to upsert jobs")
	}
...
func (o *Job) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbmodel: no Job provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: unable to delete from jobs")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: failed to get rows affected by delete for jobs")
	}
...
func (q jobQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbmodel: no jobQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: unable to delete all from jobs")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: failed to get rows affected by deleteall for jobs")
	}
...
func (o JobSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodel: unable to delete all from job slice")
	}
...
func (o *JobSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbmodel: unable to reload all in JobSlice")
	}
...
func JobExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbmodel: unable to check if jobs exists")
	}
