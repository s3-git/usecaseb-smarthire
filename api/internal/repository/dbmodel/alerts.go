...
var AlertTableColumns = struct {
	...
	ID:          "alerts.id",
	CandidateID: "alerts.candidate_id",
	Title:       "alerts.title",
	Body:        "alerts.body",
	Type:        "alerts.type",
	IsRead:      "alerts.is_read",
...
var AlertWhere = struct {
	...
	CandidateID: whereHelperint64{field: "\"alerts\".\"candidate_id\""},
	Title:       whereHelperstring{field: "\"alerts\".\"title\""},
	Body:        whereHelperstring{field: "\"alerts\".\"body\""},
	Type:        whereHelperstring{field: "\"alerts\".\"type\""},
	IsRead:      whereHelperbool{field: "\"alerts\".\"is_read\""},
...
func (o *Alert) GetCandidate() *Candidate {
	if o == nil {
		return nil
	}
...
func (r *alertR) GetCandidate() *Candidate {
	if r == nil {
		return nil
	}
...
var (
	alertAllColumns            = []string{"id", "candidate_id", "title", "body", "type", "is_read", "created_at", "updated_at"}
	alertColumnsWithoutDefault = []string{"id", "candidate_id", "title", "body", "type"}
	alertColumnsWithDefault    = []string{"is_read", "created_at", "updated_at"}
...
func (o *Alert) Candidate(mods ...qm.QueryMod) candidateQuery {
...
func (alertL) LoadCandidate(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAlert interface{}, mods queries.Applicator) error {
	var slice []*Alert
	var object *Alert
...
// SetCandidate of the alert to the related item.
// Sets o.R.Candidate to related.
// Adds o to related.R.Alerts.
func (o *Alert) SetCandidate(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Candidate) error {
	var err error
	if insert {
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(alertPrimaryKeyColumns) == 0 {
				return errors.New("dbmodel: unable to upsert alerts, could not build conflict column list")
			}
